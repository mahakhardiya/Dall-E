    ...
    const fetchPosts = async () => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          setAllPosts(result.data.reverse()); // <--- Populate allPosts here
        } else {
  ...
  return (
    <section className='max-w-7xl mx-auto p-4'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[14px] sm:text-[16px] max-w-[500px]'>
      ...
      <div className='mt-8 sm:mt-10'>
        {loading ? (
          ...
          <>
            {searchText && (
              <h2 className='font-medium text-[#666e75] text-[16px] mb-3'>
